...
#            background_filename: str = 'FCChh_tt012j.h5'):  # Added background_filename argument
...
#        self.background_filename = background_filename  # Store bkg filename
    ...
    def process(self):
        ...
        for d in self.raw_file_names:
            ...
            if d == 'signal':
                ...
                # background_file_path = os.path.join(dir_path, self.background_filename)
                # if os.path.exists(background_file_path):
                #     h5_files[d] = background_file_path
